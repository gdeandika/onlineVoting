    ...
    <div class="col-12">
        ...
        ?>
                    <table class="table">
                        <thead>
                            <tr>
                                <th colspan="4" class="bg-green text-white"><h5> Topik Voting: <?php echo strtoupper($election_topic); ?></h5></th>
                            </tr>
                            <tr>
                                <th> Foto </th>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a href="index.php?viewResult=<?php echo $election_id; ?>" class="btn btn-sm btn-primary p-2"> Download </a></td>
                                </tr>
        ...
        <?php
                ...
                echo "Tidak Ada Voting yang Aktiv.";
            }
        ?>
