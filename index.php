			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="assets/images/o.png" class="brand_logo" alt="Logo">
					</div>
				</div>
                ...
                ?>
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" name="su_contact_no" class="form-control input_pass" placeholder="No_Contact" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                        ...
                        <div class="mt-4">
                            <div class="d-flex justify-content-center links text-white">
                                Sudah Membuat Akun? <a href="index.php" class="ml-2 text-white">Log in</a>
                            </div>
                        </div>
                <?php
                    }else {
                ?>
                        ...
                        <div class="mt-4">
                            <div class="d-flex justify-content-center links text-white">
                                Belum Punya Akun? <a href="?sign-up=1" class="ml-2 text-white">Sign Up</a>
                            </div>
                ...
                <?php 
                    ...
                    {
                ?>
                        <span class="bg-white text-success text-center my-3"> Akun Anda Berhasil Dibuat! </span>
                <?php
                    }else if(isset($_GET['invalid'])) {
                ?>
                        <span class="bg-white text-danger text-center my-3"> Password Tidak Cocok, Coba Ulangi! </span>
                <?php
                    }else if(isset($_GET['not_registered'])) {
                ?>
                        <span class="bg-white text-warning text-center my-3"> Sorry, Kamu tidak dapat mendaftar! </span>
                <?php
                    }else if(isset($_GET['invalid_access'])) {
                ?>
                        <span class="bg-white text-danger text-center my-3"> Kesalahan Username dan Password! </span>
                <?php
                    }
                ?>
			</div>
